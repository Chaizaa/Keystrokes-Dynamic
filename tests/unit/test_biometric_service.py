...
class TestBiometricServiceVerification:
    ...
    def test_verify_keystroke_sample_has_required_fields(
        self, biometric_service, sample_enrollment_data
    ):
    ...
    def test_verify_keystroke_sample_confidence_score_range(
        self, biometric_service, sample_enrollment_data
    ):
