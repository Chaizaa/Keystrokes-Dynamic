...
def migrate_database():
    ...
    try:
        ...
        if 'password_strength' in columns:
            ...
            # Add column
            cursor.execute("ALTER TABLE user_vectors ADD COLUMN password_strength TEXT DEFAULT 'unknown'")
...
def migrate_csv():
    ...
    with open(backup_path, 'r', encoding='utf-8') as f:
        ...
        new_fieldnames = list(fieldnames) + ['password_strength', 'password_score', 'password_details']
